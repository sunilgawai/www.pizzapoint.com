...
const MenusPage = () => {
    return (
        <section className="container grid items-center gap-6 pb-8 md:py-2">
            <div className="grid place-items-center gap-2">
                <MainCarousel />
            </div>
            <div className="flex flex-col gap-4 p-1 border border-pink-400 border-x-0 border-y-0 border-t-1">
